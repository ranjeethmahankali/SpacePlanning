...
function space(name, nodes, runs, color){//constructor for "space" object
	...
	this.maxNegAnchors = 200;
	
	this.meanSpan = 50;//this is the preferred mean span
	this.span = this.meanSpan;//this is the default or current span
	this.spanFlex = 0.4;//this is the flexibility of span
	...
	this.travel = function(){
		...
		var currentArea = this.area() + runAr;
	...
	this.placeHead = function(pos){placeHead(this);}
...
function addRel(a,b,rF){//adds relation ship factor rF between spaces a and b
	if(rF <= 5 && rF >= -5){
		...
		alert('Add Relation Failed due to out of domain rF value = '+ rF);
	}
}
